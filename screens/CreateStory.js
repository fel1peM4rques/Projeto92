...
//adaptação: createStory== createAlugel
...
export default class CreateStory extends Component {
  ...
  //função para adcionar hidtoria no banco de dados
  async addStory(){
    ...
    if(this.state.title && this.state.description && this.state.story && this.state.moral){
      ...
      //salvando os dados no firebase(DB)
      await firebase
        .database()
    ...
    }else{//condição caso algum campo não tenha sido prenchido
      Alert.alert(
        'Error',
